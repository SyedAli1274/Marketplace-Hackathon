...
import sanityClient from "../sanity/lib/sanityClient"; // Import configured Sanity client
...
export default function ProductCards() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      const query = `*[_type == "products" && "featured" in tags] | order(_createdAt desc) [0...4]{
        _id,
        title,
        price,
  ...
  return (
    <div className="px-4 sm:px-12 lg:px-28">
      <h1 className="text-center lg:text-left font-bold mb-4 mt-6 text-[#272343] font-inter text-xl lg:text-[32px]">
        Featured Products
      </h1>

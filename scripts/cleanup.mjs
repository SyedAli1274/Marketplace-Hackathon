...
const targetClient = createClient({
  projectId: NEXT_PUBLIC_SANITY_PROJECT_ID = "wy64mgw1", // Your Sanity project ID
  ...
  token: NEXT_PUBLIC_SANITY_AUTH_TOKEN ="skQBOIFHT107UEjHkq1XSzt7HQJDURBlzjL6mbF4krDiquUV9A2iwx5iIjXdmTONcY4KYxSjE6AL9FcXJM3ROjSrdPqfT1qGbI3ffffBcfgphVgrif5srK2TrsGpcduHk2mSBJ88tTAvzNVPnHF0EqHaA0zvzU0mjsETeXQZjNgMgK3sWwso", // API token for authentication
});

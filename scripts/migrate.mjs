...
const {
  NEXT_PUBLIC_SANITY_PROJECT_ID = "wy64mgw1", // Sanity project ID
  NEXT_PUBLIC_SANITY_DATASET = "production", // Sanity dataset (e.g., "production")
  NEXT_PUBLIC_SANITY_AUTH_TOKEN = "skQBOIFHT107UEjHkq1XSzt7HQJDURBlzjL6mbF4krDiquUV9A2iwx5iIjXdmTONcY4KYxSjE6AL9FcXJM3ROjSrdPqfT1qGbI3ffffBcfgphVgrif5srK2TrsGpcduHk2mSBJ88tTAvzNVPnHF0EqHaA0zvzU0mjsETeXQZjNgMgK3sWwso", // Sanity API token
...
const targetClient = createClient({
  projectId: NEXT_PUBLIC_SANITY_PROJECT_ID || "wy64mgw1",
  dataset: NEXT_PUBLIC_SANITY_DATASET || "production", 
  useCdn: false, // Disable CDN for real-time updates
  apiVersion: "2025-06-02", // Sanity API version
  token: NEXT_PUBLIC_SANITY_AUTH_TOKEN || "skQBOIFHT107UEjHkq1XSzt7HQJDURBlzjL6mbF4krDiquUV9A2iwx5iIjXdmTONcY4KYxSjE6AL9FcXJM3ROjSrdPqfT1qGbI3ffffBcfgphVgrif5srK2TrsGpcduHk2mSBJ88tTAvzNVPnHF0EqHaA0zvzU0mjsETeXQZjNgMgK3sWwso", 
});
